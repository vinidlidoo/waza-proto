...
- Fix shipped as [plan 12 — glasses smoothing buffer](12-glasses-smoothing-buffer.md) — small ring buffer + display-link pump between DAT decode and `BufferCapturer.capture(...)` to absorb DAT bursts/stalls. Plan 11 closes here.
