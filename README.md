...
- `cd viewer && npm test` — Vitest unit tests for the Vercel token-mint API (`viewer/api/viewer-token.js`). Covers invite verification, JWT minting, missing-env behavior, and identity collision-resistance. ~200 ms.
